...
Route::get('/forgot/password/{email}/{token}', 'EmailController@forgotPassword')->name('email.forgotPassword');
Route::post('/forgot/password/update/{email}/{token}', 'EmailController@updatePassword')->name('email.updatePassword');
