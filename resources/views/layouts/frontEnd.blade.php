...
<head>
  ...
  <script src="{{ asset('end/front/sj/vendor/modernizr.min..js') }}"></script>
</head>
<body>
  ...
  <div class="owl-carousel owl-theme full-screen">
    <div class="item">
      ...
      <div class="container d-flex align-items-center text-center">
        <div class="wrap-caption">
          <p class="caption-supheading">The Best Landscaping in Pekanbaru</p>
          <h1 class="caption-heading">We Are Gaco Landscaping</h1>
          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod.</p>
          <a href="#" class="btn btn-secondary">MORE ABOUT US</a> <a href="#" class="btn btn-primary">HIRE US NOW</a>
        </div>
      </div>
    </div>
    <div class="item">
      ...
      <div class="container d-flex align-items-center text-center">
        <div class="wrap-caption">
          <p class="caption-supheading">The Best Landscaping in Pekanbaru</p>
          <h1 class="caption-heading">Landscaping & Gardening</h1>
          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod.</p>
          <a href="#" class="btn btn-secondary">MORE ABOUT US</a> <a href="#" class="btn btn-primary">HIRE US NOW</a>
        </div>
      </div>
    ...
    <div class="item">
      ...
      <div class="container d-flex align-items-center text-center">
        <div class="wrap-caption">
          <p class="caption-supheading">The Best Landscaping in Pekanbaru</p>
          <h1 class="caption-heading">High Quality & Guaranted</h1>
          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod.</p>
          <a href="#" class="btn btn-secondary">MORE ABOUT US</a> <a href="#" class="btn btn-primary">HIRE US NOW</a>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-12">
          ...
          <p class="subheading text-center mb-5">Start growing with Gaco Html Template</p>
        </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
          <div class="footer-item">
            ...
            <div class="row mb-3">
              ...
              <div class="col-7">info@yoursite.com</div>
            </div>
...
<!-- JS VENDOR -->
<script src="{{ asset('end/front/sj/vendor/jquery.min..js') }}"></script>
<script src="{{ asset('end/front/sj/vendor/bootstrap.min..js') }}"></script>
<script src="{{ asset('end/front/sj/vendor/owl.carousel..js') }}"></script>
<script src="{{ asset('end/front/sj/vendor/jquery.magnific-popup.min..js') }}"></script>

<!-- SENDMAIL -->
<script src="{{ asset('end/front/sj/vendor/validator.min..js') }}"></script>
<script src="{{ asset('end/front/sj/vendor/form-scripts..js') }}"></script>

<script src="{{ asset('end/front/sj/script..js') }}"></script>
</body>
</html>
